...
public class Link extends _Properties implements Comparable<Link> {
	...
	public Node source;
	/**
	 * The destination node of this link (if directed), the second endpoint
	 * otherwise.
	 */
	 ...
	 * <tt>from</tt> and <tt>to</tt>. The respective order of <tt>from</tt> and
	 * <tt>to</tt> does not matter if the specified type is undirected.
	 * 
	 * @param from
	 *            The source node.
	 * @param to
	 *            The destination node.
	 * @param type
	 *            The type of the link (<tt>Type.DIRECTED</tt> or
	 *            <tt>Type.UNDIRECTED</tt>).
	 */
	 ...
	 * <tt>from</tt> and <tt>to</tt>. The created link is undirected by default.
	 * The respective order of <tt>from</tt> and <tt>to</tt> does not matter.
	 * 
	 * @param from
	 *            The source node.
	 * @param to
	 *            The destination node.
	 * @param mode
	 *            The mode of the link (<tt>Mode.WIRED</tt> or
	 *            <tt>Mode.WIRELESS</tt>).
	 */
	 ...
	 * <tt>mode</tt> between the nodes from and to. The created link is wired by
	 * default. The respective order of <tt>from</tt> and <tt>to</tt> does not
	 * matter if the type is undirected.
	 * 
	 * @param from
	 *            The source node.
	 * @param to
	...
	/**
	 * Returns the node located at the opposite of the specified node (reference
	 * node) on the underlying link.
	 * 
	 * @param n
	 *            The reference node.
	...
	public boolean equals(Object o) {
		...
		return ((this.type == l.type)
				&& (l.source == this.source && l.destination == this.destination) || (this.type == Type.UNDIRECTED && (l.source == this.destination && l.destination == this.source)));
	}
